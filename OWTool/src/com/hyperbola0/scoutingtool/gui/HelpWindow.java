...
public class HelpWindow extends JFrame {
	...
	public HelpWindow() {
		...
		sb.append(" * You can now see the players' info as soon as its found, instead of waiting for the whole team to load\n");
		sb.append(" * Bug fixes:\n");
		...
		sb.append("Pressing either team's button will fill in the battletags for the team members and scrape the team's info. ");
		sb.append("The team's average SR is calculated and displayed in the match panel.\n\n");
		sb.append("For each player, the SR is shown next to their battletag and their top heroes are displayed underneath. ");
		sb.append("Pressing \"Player URL\" will copy the playoverwatch.com url to your clipboard, where you can paste it in your browser. ");
		sb.append("If the player has a private profile or the profile is not found, the program will check for an overbuff profile, ");
